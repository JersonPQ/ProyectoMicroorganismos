public interface Constantes {
    final int maxVelocidad = 0; //Maximo de velocidad
    final int maxVision = 0; //Maximo de Vision
    final int maxEnergia = 0; //Maximo de energia
    ...
    final int cantAlimentos = 100; //Cantidad de alimentos
